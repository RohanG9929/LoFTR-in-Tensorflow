...
def warp_kpts(kpts0, depth0, depth1, T_0to1, K0, K1):
    ...
    kpts0_depth = tf.stack(
        [depth0.numpy()[i, kpts0_long[i, :, 1].numpy().astype(int), kpts0_long[i, :, 0].numpy().astype(int)] 
    ...
    w_kpts0_depth = tf.stack(
        [depth1.numpy()[i, w_kpts0_long[i, :, 1].numpy().astype(int), w_kpts0_long[i, :, 0].numpy().astype(int)] 
